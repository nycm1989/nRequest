...
class NCustomRequest{
  ...
  static const List<StatusData> _st = [
    ...
    StatusData(type: StatusType.successful,  code: 203, description: "Non-Authoritative Information"   ),
    StatusData(type: StatusType.successful,  code: 204, description: "No Content"                      ),
    StatusData(type: StatusType.successful,  code: 205, description: "Reset Content"                   ),
    StatusData(type: StatusType.successful,  code: 206, description: "Partial Content"                 ),
    StatusData(type: StatusType.successful,  code: 207, description: "Multi-Status"                    ),
    StatusData(type: StatusType.successful,  code: 208, description: "Already Reported"                ),
    StatusData(type: StatusType.successful,  code: 226, description: "IM Used"                         ),
