...
class StatusRepository {
  List<StatusData> get list => [
    StatusData(type: StatusType.exception,     isValid: false, code: 0,    description: "FrontEnd Exception"                              ),
    ...
    StatusData(type: StatusType.serverError,   isValid: false, code: 525,  description: "SSL/TLS handshake failed or invalid certificate" ),
  ];

  StatusData getStatus(int code) => list.singleWhere((status) => status.code == code, orElse: () => list.first);
}